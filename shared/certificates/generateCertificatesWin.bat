@REM Unused?
@REM validity_contract_cert=730
@REM validity_mo_subca1_cert=1460
@REM validity_mo_subca2_cert=1460
@REM validity_oem_prov_cert=1460
@REM validity_oem_subca1_cert=1460
@REM validity_oem_subca2_cert=1460
@REM validity_cps_leaf_cert=90
@REM validity_cps_subca1_cert=1460
@REM validity_cps_subca2_cert=730
set validity_secc_cert="60"
set validity_cpo_subca1_cert="1460"
set validity_cpo_subca2_cert="365"
set validity_v2g_root_cert="9125"
set validity_oem_root_cert="3650"
@REM Unsed?
@REM validity_mo_root_cert=3650
@REM validity_vehicle_subca1_cert=3650 @REM repeated in the following line
set validity_vehicle_subca1_cert="3650"
set validity_vehicle_subca2_cert="3650"
set validity_vehicle_cert="3650"
...
@REM # TLS_CHACHA20_POLY1305_SHA256 cipher suite is used to encrypt private keys for local storage.
@REM # This has no effect in the use of TLS_AES_256_GCM_SHA384 cipher suite or TLS_CHACHA20_POLY1305_SHA256
...
@REM # seccCertChain
copy .\certs\seccCert.pem + .\certs\cpoSubCA2Cert.pem + .\certs\cpoSubCA1Cert.pem .\certs\seccCertChain.pem
...
@REM # vehicleCertChain
copy .\certs\vehicleCert.pem + .\certs\vehicleSubCA2Cert.pem + .\certs\vehicleSubCA1Cert.pem .\certs\vehicleCertChain.pem
pause